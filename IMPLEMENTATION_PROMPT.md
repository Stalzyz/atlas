...
API base URL: `https://api.atlas.in/api/v1`  
Storefront URL: `https://atlas.in`
...
Test: `curl -I https://api.atlas.in/api/v1/marketing/facebook-feed.xml` should return `200 OK`.
