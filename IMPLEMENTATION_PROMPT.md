# Raaghas Enterprise — Implementation Prompt
...
API base URL: `https://api.raaghas.in/api/v1`  
Storefront URL: `https://raaghas.in`
...
Test: `curl -I https://api.raaghas.in/api/v1/marketing/facebook-feed.xml` should return `200 OK`.
