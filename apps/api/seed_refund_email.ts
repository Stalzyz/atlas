...
async function run() {
  ...
  <p>If you opted for Store Credit, it is instantly available in your {{storeSettings.storeName}} Wallet.</p>
  <div style="margin-top: 40px; border-top: 1px solid #eee; padding-top: 20px; text-align: center; color: #888; font-size: 12px;">
    {{storeSettings.footerCopyright}} | {{storeSettings.businessAddress}}
  </div>
</div>`
    }
  });
