...
PORT=6005 pm2 start apps/api/dist/src/main.js --name atlas-api 2>&1 &
PM2_API_PID=$!

echo "Starting atlas-admin..."
PORT=6010 pm2 start apps/admin/server.js --name atlas-admin 2>&1 &
PM2_ADMIN_PID=$!

echo "Starting atlas-storefront..."
PORT=6009 pm2 start apps/storefront/server.js --name atlas-storefront 2>&1 &
PM2_STOREFRONT_PID=$!
