            ...
            >
              ...
              {plan.name === 'Atlas CMS' && (
                <a
                  ...
                  target="_blank"
                  rel="noopener noreferrer"
                  className="w-full mt-3 py-3 rounded-xl font-semibold text-center border-2 border-white/60 text-white hover:bg-white/15 transition-all text-sm flex items-center justify-center gap-2"
                >
