...
PORT=6005
NODE_ENV=production
API_URL=https://api.atlas.in
CORS_ORIGINS=https://atlas.in,https://www.atlas.in,https://admin.atlas.in
...
echo "━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━"
sleep 5
HTTP_STATUS=$(curl -s -o /dev/null -w "%{http_code}" https://api.atlas.in/api/v1/products)
